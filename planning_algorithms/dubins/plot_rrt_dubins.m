function plot_rrt_dubins(gca, verticies, edges)
% PLOT_RRT_DUBINS Plot RRT graph for Dubins vehicle trajectory.

scatter(gca, verticies(1, 1), ...
             verticies(1, 2), 45, '*','r','LineWidth',1); hold on;
scatter(gca, verticies(:,1), ...
             verticies(:,2), 10,linspace(1,10,length(verticies(:,1))), 'filled');
hold on;

vert_count = length(verticies);
